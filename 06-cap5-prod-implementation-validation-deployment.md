...
| ------------- | --------------------------------------------------------------- | ------- | ------------------------- | --------------------------------------------------------------------------------------------------------- | --------------- |
| US-001         | Ver testimonios de clientes               | T001    |  US001TASK001        | Mostrar formulario de inicio de sesión.                            | 1/2 h           |
|               |                                                                 | T002    | US001TASK002 | Validar formato de correo y requerir contraseña obligatoria.               | 1h              |
|               |                                                                 | T003    | US001TASK003          | Implementar botón de "Iniciar sesión" para enviar los datos.                 | 1/2h            |
...
|               |                                                                 | T008    | US003TASK002 | Codificar el componente necesario para 'incluir llamados a la acción (cta) con redirección y descarga'. | 1h              |
|               |                                                                 | T009    | US003TASK003          | Verificar que 'incluir llamados a la acción (cta) con redirección y descarga' funcione correctamente.   | 1/2h            |
| US-004        | Visualización persistente de información institucional en todo el sitio                       | T010    | US004TASK001         | Crear diseño visual para 'visualización de la barra de navegación'.                                    | 1/2h            |
|               |                                                                 | T011    | US004TASK002 | Codificar el componente necesario para 'visualización de la barra de navegación'.                       | 1h              |
|               |                                                                 | T012    | US004TASK003          | Verificar que 'visualización de la barra de navegación' funcione correctamente.                         | 1/2h            |
| US-005         | Acceso a secciones principales del sitio                      | T013    | US005TASK001        | Crear diseño visual para 'visualización de pasos del funcionamiento'.                                   | 1/2h            |
|               |                                                                 | T014    | US005TASK002 | Codificar el componente necesario para 'visualización de pasos del funcionamiento'.                      | 1h              |
|               |                                                                 | T015    | US005TASK003          | Verificar que 'visualización de pasos del funcionamiento' funcione correctamente.                        | 1/2h            |
| US-006         | Conocer el funcionamiento general de la plataforma                               | T016    | US006TASK001         | Crear diseño visual para 'alternativa con video explicativo'.                                            | 1/2h            |
|               |                                                                 | T017    | US006TASK002 | Codificar el componente necesario para 'alternativa con video explicativo'.                               | 1h              |
|               |                                                                 | T018    | US006TASK003          | Verificar que 'alternativa con video explicativo' funcione correctamente.                                 | 1/2h            |
| US-007         | Opción de comprender el funcionamiento mediante recurso audiovisual                        | T019    | US007TASK001         | Crear diseño visual para 'visualización de footer en landing page'.                                     | 1/2h            |
|               |                                                                 | T020    | US007TASK002 | Codificar el componente necesario para 'visualización de footer en landing page'.                        | 2h              |
|               |                                                                 | T021    | US007TASK003          | Verificar que 'visualización de footer en landing page' funcione correctamente.                          | 1/2h            |
| US-008         | Comprensión del propósito y valor desde el inicio                                     | T022    | US008TASK001         | Crear diseño visual para 'ver testimonios de clientes'.                                                  | 2h              |
|               |                                                                 | T023    | US008TASK002 | Codificar el componente necesario para 'ver testimonios de clientes'.                                     | 1/2h            |
|               |                                                                 | T024    | US008TASK003          | Verificar que 'ver testimonios de clientes' funcione correctamente.                                       | 1h              |
| US-009         | Visualización de beneficios según perfil de usuario                                  | T025    | US009TASK001         | Crear diseño visual para 'consultar preguntas frecuentes'.                                               | 1/2h            |
|               |                                                                 | T026    | US009TASK002 | Codificar el componente necesario para 'consultar preguntas frecuentes'.                                  | 1h              |
|               |                                                                 | T027    | US009TASK003          | Verificar que 'consultar preguntas frecuentes' funcione correctamente.                                    | 1/2h            |
| US-011         | Selección de idioma para una experiencia personalizada                                   | T028    | US011TASK001         | Crear diseño visual para 'enviar formulario de contacto'.                                                | 1h              |
|               |                                                                 | T029    | US011TASK002 | Codificar el componente necesario para 'enviar formulario de contacto'.                                   | 1/2h            |
|               |                                                                 | T030    | US011TASK003          | Verificar que 'enviar formulario de contacto' funcione correctamente.                                     | 1h              |
...
| US-013         | Optimización para pantallas de escritorio                            | T034    | US013TASK001         | Crear diseño visual para 'visualización responsive en desktop'.                                         | 1/2h            |
|               |                                                                 | T035    | US013TASK002 | Codificar el componente necesario para 'visualización responsive en desktop'.                            | 1h              |
|               |                                                                 | T036    | US013TASK003          | Verificar que 'visualización responsive en desktop' funcione correctamente.                              | 1/2h            |
| US-014         | Optimización para pantallas de tablet              | T037    | US014TASK001         | Crear diseño visual para 'visualización responsive en dispositivos móviles'.                           | 1h              |
|               |                                                                 | T038    | US014TASK002 | Codificar el componente necesario para 'visualización responsive en dispositivos móviles'.              | 1/2h            |
|               |                                                                 | T039    | US014TASK003          | Verificar que 'visualización responsive en dispositivos móviles' funcione correctamente.                | 1/2h            |
| US-015         | Optimización para dispositivos móviles                             | T040    | Diseñar sección         | Crear diseño visual para 'visualización responsive en tablet'.                                          | 1/2h            |
...
| US-016         | Navegación fluida entre secciones                                                        | T043    | Diseñar sección         | Crear diseño visual para 'registro'.                                                                     | 2h              |
